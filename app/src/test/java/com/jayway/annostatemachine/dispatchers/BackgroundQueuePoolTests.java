...
public class BackgroundQueuePoolTests {
    ...
    public void testSameDispatcherReturnedForSameId() {
        BackgroundQueueDispatcher dispatcher1 = BackgroundQueuePool.getInstance().acquire(0, null, mMockLogger);
        BackgroundQueueDispatcher dispatcher2 = BackgroundQueuePool.getInstance().acquire(0, null, mMockLogger);
    ...
    public void testNotSameDispatcherReturnedForDifferentIds() {
        BackgroundQueueDispatcher dispatcher1 = BackgroundQueuePool.getInstance().acquire(0, null, mMockLogger);
        BackgroundQueueDispatcher dispatcher2 = BackgroundQueuePool.getInstance().acquire(1, null, mMockLogger);
    ...
    public void testNewDispatcherCreatedIfNullingReferences() throws InterruptedException {
        ...
        System.gc();
        BackgroundQueueDispatcher dispatcher3 = BackgroundQueuePool.getInstance().acquire(0, null, mMockLogger);
